        ...
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-block btn-info btn-lg" id = "edit" name = "edit"><i class = "fa fa-edit"></i></button>
                    <button type="button" class="btn btn-block btn-danger btn-lg" id  ="delete" name = "delete" onclick = "DeleteRecord();"><i class = "fa fa-trash"></i></button></td>
                </tr><?php }} ?>
                </tfoot>
                </table>
            </div>
